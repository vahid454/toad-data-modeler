...
<html lang="en">
  ...
  <body class="bg-white"><font align=center color='red'><p align=center>
<h3>Some Frequently Asked Questions</h3>
<br>     <font size='3px' color='black'
<p>Q.1) Can I sing up without mobile number and How?</p>
<p>Ans. :- Yes ! Aspirant you can signUp without mobile number just give any residental proof through any of these documens - 
Aadhar , Voter ID, Electricity bill, Bank passbook .
 </p>
<p>Q.2) Can I learn a lot of things here? </p>
<p>Ans. :- This platform provide you to generate SQL. This will absolutely help u more</p>

<p>Q.3) Without email??</p>
<p>Ans. :- Not Possible, u need a email for registration.</p>

<p>Q.4) How much cost it take for generating SQLs ? </p>
<p>Ans. :- Dear, We provide many plans at monthly rate, yearly rate,, and also some free projects and free tables.
You can check it out our all plans using site informations.
</p>


</font> <a class="d-block large" href="signUp.jsp"><font text-align=center>Click Here to Sign Up</font></a></p>
    </font>    
  </body>
