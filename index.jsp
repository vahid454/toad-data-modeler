  ...
  <body class="bg-dark">
    ...
    <div class="container">
      <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
          <form action='/dbproject/webservice/memberService/login' onsubmit='return validateForm(this)' method='POST' novalidate>
            <div class="form-group">
              <div class="form-label-group">
                <input type="email" id="inputEmail" name="argument-1" class="form-control" placeholder="Email address" required="required" autofocus="autofocus" value=${emailId}>
                <label for="inputEmail">Email address</label>
              </div>
 <p class="text-danger">${emailIdError}</p>
            </div>
            <div class="form-group">
              <div class="form-label-group">
...
<h7 class="text-danger">${authenticationError}</h7>               
            </div>
            <input type='submit' class="btn btn-primary btn-block" value='Login'>
          </form>
          <div class="text-center">
            <a class="d-block small mt-3" href="/dbproject/signUp.jsp">Register an Account</a>
            <a class="d-block small" href="/dbproject/forgot-password.jsp">Forgot Password?</a>
          </div>
        </div>
      </div>
    </div>
...
<!-- Our Main needed contains ended here , other parts for css or js -->
