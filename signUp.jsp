...
memberServiceManager.create(member,function(res){
var ff=document.getElementById("loginSuccessForm");
ff.submit();
...
<div class="card-header"><h2>Sign  Up </h2>Please fill the details below</div>
<div class="card-body">
...
<input type='text' id='firstName' class='form-control' placeholder='First Name' required='required' autofocus='autofocus' onkeypress='document.getElementById("firstName").style.borderColor="#92a8d1" , document.getElementById("firstNameSpan").innerHTML="" '>
...
<div class='col-md-6'>
<div class='form-label-group'>
<input type='text' id='lastName' class='form-control' placeholder='Last Name' required='required' autofocus='autofocus' onkeypress='document.getElementById("lastName").style.borderColor="#92a8d1",document.getElementById("lastNameSpan").innerHTML="" '>
...
<div class='col-md-12'>
<div class='form-label-group'>
<input type='text' id='emailId' placeholder='Email Id' required='required' class='form-control' onkeypress='document.getElementById("emailId").style.borderColor="#92a8d1", document.getElementById("emailIdSpan").innerHTML="" '>
...
<div class='col-md-12'>
<div class='form-label-group'>
<input type='text' id='mobileNumber' placeholder='Sonu' required='required' class='form-control' onkeypress='document.getElementById("mobileNumber").style.borderColor="#92a8d1" , document.getElementById("mobileNumberSpan").innerHTML="" '>
...
<button type='button' onclick='processInstallationForm()' class="btn btn-primary btn-block">Register</button>
<center><a href='/dbproject/index.jsp'>Already have an account</a><br>
...
<form id='loginSuccessForm' action='loginSuccessForm.jsp'></form>
</body>
</html>